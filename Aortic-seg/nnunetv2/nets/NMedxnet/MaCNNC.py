...
class NMedNeXt(nn.Module):
    def __init__(self,
        ...
        # self.enc_block_0 = ViLLayer(dim=n_channels)
        ...
        # self.enc_block_1 = ViLLayer(dim=n_channels*2)
        ...
        # self.enc_block_2 = ViLLayer(dim=n_channels*4)
        ...
        # self.enc_block_3 = ViLLayer(dim=n_channels * 8)
        ...
        self.bottleneck2 = ViLLayer(dim=n_channels*16)
    ...
    def forward(self, x):
        ...
        if self.outside_block_checkpointing:
            ...
            if self.do_ds:
                # xx = checkpoint.checkpoint(self.Cascade_attention3, x, self.dummy_tensor)
