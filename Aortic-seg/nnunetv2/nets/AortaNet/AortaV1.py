...
class Aorta1(nn.Module):
    def __init__(self,
        ...
        self.stem00 = conv(in_channels, n_channels, kernel_size=1)
        self.stem0 = nn.Conv3d(in_channels, n_channels, kernel_size=7, stride=1, padding=3)
        # self.stem0 = nn.Conv3d(in_channels, n_channels, kernel_size=5, stride=1, padding=3)
        # self.stem0 = nn.Conv3d(in_channels, n_channels, kernel_size=3, stride=1, padding=1)
        if type(exp_r) == int:
    ...
    def forward(self, x):
        ...
        if self.outside_block_checkpointing:
            ...
            x_res_00 = self.iterative_checkpoint(self.enc_block_00, xx)
