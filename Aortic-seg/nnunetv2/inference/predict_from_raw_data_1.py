...
if __name__ == '__main__':
    ...
    input_dir = "a"
    output_dir="b"
    # inference.predict_1a(input_dir, output_dir)#512x512
    inference.predict_1b(input_dir, output_dir)#300x300