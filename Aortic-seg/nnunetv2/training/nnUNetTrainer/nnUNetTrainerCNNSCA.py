from nnunetv2.nets.CNNSCA.CNNSCA import CNNSCA#原始
...
#segmanba+medxnet
class nnUNetTrainerCNNSCA(nnUNetTrainer):
    @staticmethod
    def build_network_architecture(plans_manager: PlansManager,
        ...
        # model = MaCNN3(in_channels=num_input_channels, n_channels=32,  # 增大通道，减少卷积核l3
        ...
        model = CNNSCA(in_channels=num_input_channels, n_channels=32,  # 增大通道，减少卷积核l3
