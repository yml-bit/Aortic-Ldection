    ...
    for root, dirs, files in os.walk(src_data_folder, topdown=False):
        for file in files:
            ...
            if "0.nii.gz" in path:
                ...
                elif "nor" not in path:
                    patients_train.append(path)

            if "hnnk" not in path:
                if "0.nii.gz" in path and "dml" in path:
                    patients_train.append(path)
...
if __name__ == "__main__":
    ...
    #/../../../yml/project/python310/p3/xLSTM-UNet/UxLSTM/nnunetv2/dataset_conversio/
    #/media/bit301/data/yml/project/python310/p3/xLSTM-UNet/UxLSTM/nnunetv2/dataset_conversio/
    dataset_id=301
